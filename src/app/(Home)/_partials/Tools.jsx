...
export default function Tools() {
  return (
    <section id="tools" className="-mt-32 lg:mt-20">
      <marquee behavior="" direction="" className="-my-2 p-3 bg-gray-100 lg:p-4 border-t dark:bg-neutral-950 dark:border-neutral-800">
