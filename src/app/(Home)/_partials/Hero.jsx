    ...
    <section id="hero" className="mt-24 grid lg:grid-cols-2">
       <div className="flex flex-col items-start gap-8 mt-10 mx-4 lg:mt-32 lg:ml-20 xl:ml-48 lg:mr-0">
         ...
         <div className="flex gap-1">
          <h1 className="text-4xl -my-6 poppins-bold text-cyan-400 lg:text-7xl lg:my-0 xl:text-7xl">
            <Typewriter 
              options={{
                loop: true
              }}
          ...
          <h1 className="h1-outline text-4xl -my-6 poppins-bold lg:text-7xl lg:my-0 dark:h1-outline-white xl:text-7xl">
            SETIADI
          </h1>
         </div>
