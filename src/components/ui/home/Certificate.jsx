  ...
  return (
    <section id="web-development" className="mt-24 lg:mt-32">
      <div className="text-center">
        <h1 className="text-3xl poppins-bold text-gray-800">Certificate</h1>
        <p className="line-height-2 px-3 text-xs text-gray-600 mt-2 lg:px-40 lg:text-base">
          Tap to zoom in Certificate
        </p>
        <div className="bg-gray-100 p-4 grid gap-2 items-center my-10 lg:grid-cols-2 lg:mx-24 xl:mx-72">
      ...
      <div id='popup-open' className={`${!popupOpen && 'hidden'}`}>
        <div className='fixed z-40 overflow-y-scroll inset-0 bg-slate-300 bg-opacity-40 backdrop-blur-sm p-6'>
          <section className='flex justify-between text-gray-700'>
            ...
            <button type='button' onClick={() => setPopupOpen(!popupOpen)} className='nav-list-item-1 bg-slate-100 bg-opacity-50 backdrop-blur-sm h-fit p-1 ml-auto rounded-md hover:bg-slate-300'>
