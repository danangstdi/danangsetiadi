    ...
    <section id="hero" className="mt-24 grid overflow-hidden max-h-[46rem] lg:grid-cols-2 lg:max-h-[43rem]">
       <div className="flex flex-col items-start gap-8 mt-10 mx-4 lg:mt-32 lg:ml-48 lg:mr-0">
         ...
         <div className="flex gap-1">
          <h1 className="text-4xl -my-6 poppins-bold text-teal-400 lg:text-7xl lg:my-0">
            <Typewriter 
              options={{
                loop: true
              }}
         ...
         <Link href='' onClick={handleToast} className="text-xs flex items-center gap-2 py-3 px-12 bg-gradient-to-r from-teal-400 to-pink-600 rounded-full text-white shadow-lg group lg:text-sm">
